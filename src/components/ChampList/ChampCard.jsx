...
const ChampCard = ({ champ, setCurrentChamp, setChampList, setCurrentChampLinks, currentChampLinks, linksType, setChampName, champCardImg }) => {
    ...
    */
    ...
    return (
        ...
        */
        <>
            { <div className='champ-card text-white' onClick={() => setCurrentChamp(champ.name)} style={{ backgroundImage: `url(${location.pathname == '/list' ? champ.image : champCardImg})`, backgroundSize: "cover" }}>
                {displayAttributes ? (
