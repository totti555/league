  ...
  return (
    <div className="home-content bg-black  text-white">
      <div className="Banner">
        <img className="first-image" src={Banner} width="100%"></img>
      </div>
      ...
      <div >
        <div className="img-vitrine d-flex justify-content-center mb-2">
          <img className="site-overview" src={Ahri} width="100%"></img>
        </div>
      ...
      <div className="home-text">
        ...
        <p>
          ...
          est des fonctionnalités, regarde <a><strong className="underline"> le petit screen ci-dessous !</strong></a>
        </p>
        <p>
          ...
          Pour cela, rendez vous sur la page <strong className="underline">Look !</strong>
        </p>
 
      </div>

      <div className="home-video mb-16">
        <img src={SiteView}></img>
      </div>
