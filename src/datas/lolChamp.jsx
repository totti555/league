...
import Akshan from "../assets/Champ/Akshan.jpg"
import Alistar from "../assets/Champ/Alistar.jpg"
import Amumu from "../assets/Champ/Amumu.jpg"
import Anivia from "../assets/Champ/Anivia.jpg"
import Annie from "../assets/Champ/Annie.jpg"
import Aphelios from "../assets/Champ/Aphelios.jpg"
import Ashe from "../assets/Champ/Ashe.jpg"
import AurelionSol from "../assets/Champ/Aurelion_Sol.jpg"
import Azir from "../assets/Champ/Azir.jpg"
import Bard from "../assets/Champ/Bard.jpg"
import Belveth from "../assets/Champ/Belveth.jpg"
import Blitzcrank from "../assets/Champ/Blitzcrank.jpg"
import Brand from "../assets/Champ/Brand.jpg"
import Braum from "../assets/Champ/Braum.jpg"
import Caitlyn from "../assets/Champ/Caitlyn.jpg"
import Camille from "../assets/Champ/Camille.jpg"
...
import Ekko from "../assets/Champ/Ekko.jpg"
import Elise from "../assets/Champ/Elise.jpg"
import Evelynn from "../assets/Champ/Evelynn.jpg"
import Ezreal from "../assets/Champ/Ezreal.jpg"
import Fiddlesticks from "../assets/Champ/Fiddlesticks.jpg"
import Fiora from "../assets/Champ/Fiora.jpg"
...
import Gwen from "../assets/Champ/Gwen.jpg"
...
import Jax from "../assets/Champ/Jax.jpg"
...
import Kassadin from "../assets/Champ/Kassadin.jpg"
import Katarina from "../assets/Champ/Katarina.jpg"
...
import Nami from "../assets/Champ/Nami.jpg"
import Nasus from "../assets/Champ/Nasus.jpg"
import Nautilus from "../assets/Champ/Nautilus.jpg"
import Neeko from "../assets/Champ/Neeko.jpg"
import Nidalee from "../assets/Champ/Nidalee.jpg"
import Nilah from "../assets/Champ/Nilah.jpg"
import Nocturne from "../assets/Champ/Nocturne.jpg"
import Nunu from "../assets/Champ/Nunu&Willump.jpg"
import Olaf from "../assets/Champ/Olaf.jpg"
...
import Reksai from "../assets/Champ/Reksai.jpg"
import Rell from "../assets/Champ/Rell.jpg"
import Renata from "../assets/Champ/Renata_Glasc.jpg"
import Renekton from "../assets/Champ/Renekton.jpg"
import Rengar from "../assets/Champ/Rengar.jpg"
import Riven from "../assets/Champ/Riven.jpg"
...
export const champList = [
    ...
    },
    {
        ...
        release: '2009-02-21',
        linksWith: [{ Tryndamere: 'Boyfriend', Gragas: 'Friends', Sejuani: 'Friends\nEnnemy', Lissandra: 'Ennemy' }]
    },
    {
        name: 'AurelionSol',
        world: 'Runeterra',
    ...
    },
    {
        ...
        type: ["Mage", 'Marksman'],
        release: '2014-09-16',
        linksWith: [{ Sivir: 'Descendant\nFriends', Renekton: 'Friends', Xerath: 'Friends', Nasus: 'Allie' }]
    },
    {
        name: 'Bard',
        world: 'Runeterra',
    ...
    },
    {
        ...
        type: ["Tank", 'Fighter'],
        release: '2009-09-02',
        linksWith: [{ Viktor: 'Father', Oriana: 'Allie' }]
    },
    {
        name: 'Brand',
        world: 'Runeterra',
    ...
    },
    {
        ...
        type: ["Marksman"],
        release: '2011-01-04',
        linksWith: [{ Jinx: 'Sister\nEnnemy', Vi: 'Potential Girlfriend\nFriends' }]
    },
    {
        name: 'Camille',
        world: 'Piltover',
    ...
    },
    {
        ...
        type: ["Fighter", 'Tank'],
        release: '2012-05-23',
        linksWith: [{ Draven: 'Brother', Swain: 'Allie', Katarina: 'Allie', Talon: 'Allie' }]
    },
    {
        name: 'Diana',
        world: 'Targon',
    ...
    },
    {
        ...
        type: ["Marksman"],
        release: '2012-06-06',
        linksWith: [{ Darius: 'Brother', Swain: '???' }]
    },
    {
        name: 'DrMundo',
        world: 'Zaun',
    ...
    },
    {
        ...
        release: '2015-05-29',
        linksWith: [{ Jinx: 'Potential Friends', Vi: 'Potential Friends', Renata: '???' }]
    },
    {
        name: 'Elise',
        world: 'Shadow Isles',
    ...
    },
    {
        ...
        type: ["Marksman", 'Mage'],
        release: '2010-03-16',
        linksWith: [{ Heimerdinger: 'Mentor', Lux: 'Potential Girlfriend', Zoe: 'Potential Girlfriend' }]
    },
    {
        name: 'Fiddlesticks',
        world: 'Runeterra',
    ...
    },
    {
        ...
        type: ["Tank", 'Mage'],
        release: '2010-08-10',
        linksWith: [{ Lux: 'Friends', Sylas: 'Friends' }]
    },
    {
        name: 'Gangplank',
        world: 'Bilgewater',
        ...
        type: ["Fighter"],
        release: '2009-08-19',
        linksWith: [{ Illaoi: 'Girlfriend', Graves: 'Ennemy', Swain: 'Ennemy', Zed: 'Ennemy' }]
    ...
    },
    {
        ...
        type: ["Fighter", 'Tank'],
        release: '2010-04-27',
        linksWith: [{ Lux: 'Sister', JarvanIV: 'Friends', Quinn: 'Allie', XinZhao: 'Allie', Nocturne: 'Ennemy', Katarina: 'Potential Girlfriend' }]
    },
    {
        name: 'Gnar',
        world: 'Freljord',
    ...
    },
    {
        ...
        type: ["Marksman"],
        release: '2011-10-19',
        linksWith: [{ TwistedFate: 'Friends', Gangplank: 'Ennemy', MissFortune: 'Allie', Nilah: '???' }]
    },
    {
        name: 'Gwen',
        world: 'Shadow Isles',
        ...
        type: ["Fighter", 'Assassin'],
        release: '2021-04-15',
        linksWith: [{ Maokai: 'Ennemy', Viego: 'Ennemy', Yorick: 'Ennemy' }]
    },
    {
        name: 'Hecarim',
        world: 'Shadow Isles',
        ...
        type: ["Fighter", 'Tank'],
        release: '2012-04-18',
        linksWith: [{ Viego: 'Allie', Kallista: 'Ennemy' }]
    },
    {
        name: 'Heimerdinger',
        world: 'Piltover',
        ...
        type: ["Mage", 'Support'],
        release: '2009-10-10',
        linksWith: [{ Ziggs: 'Allie', Rumble: 'Ennemy', Ezreal: 'Apprentice' }]
    },
    {
        name: 'Illaoi',
        world: 'Ionia',
        ...
        type: ["Fighter", 'Tank'],
        release: '2015-11-24',
        linksWith: [{ MissFortune: 'Friends', Gangplank: 'Boyfriend', Nilah: '???' }]
    },
    {
        name: 'Irelia',
        world: 'Ionia',
    ...
    },
    {
        ...
        type: ['Tank', "Fighter"],
        release: '2011-03-01',
        linksWith: [{ Garen: 'Friends', Shyvana: 'Friends', XinZhao: 'Allie\nMentor', Quinn: 'Allie', Sion: 'Ennemy' }]
    },
    {
        name: 'Jax',
        world: 'Runeterra',
    ...
    },
    {
        ...
        release: '2012-07-07',
        linksWith: [{ Skarner: 'Ennemy', Viktor: 'Ennemy' }]
    },
    {
        name: 'Jhin',
        world: 'Ionia',
        ...
        type: ["Marksman"],
        release: '2016-02-01',
        linksWith: [{ Camille: 'Ennemy', Shen: 'Ennemy' }]
    },
    {
        name: 'Jinx',
        world: 'Zaun',
        ...
        type: ["Marksman"],
        release: '2013-10-10',
        linksWith: [{ Vi: 'Sister\nEnnemy', Ziggs: 'Friends', Caitlyn: 'Ennemy', Ekko: 'Potential Friends' }]
    },
    {
        name: 'KaiSa',
        world: 'Void',
    ...
    },
    {
        ...
        type: ["Marksman"],
        release: '2014-11-20',
        linksWith: [{ Viego: 'Allie\nEnnemy', Hecarim: 'Ennemy' }]
    },
    {
        name: 'Karma',
        world: 'Ionia',
    ...
    },
    {
        ...
        type: ['Mage'],
        release: '2009-06-12',
        linksWith: [{ Maokai: 'Ennemy', Yorick: 'Ennemy' }]
    },
    {
        name: 'Kassadin',
        world: 'Void',
    ...
    },
    {
        ...
        role: ['Top'],
        image: Kayle,
        type: ['Fighter', 'Support'],
        release: '2009-02-21',
        linksWith: [{ Morgana: 'Sister' }]
    },
    {
        name: 'Kayn',
        world: 'Ionia',
    ...
    },
    {
        ...
        type: ['Mage', 'Marksman'],
        release: '2010-04-08',
        linksWith: [{ Akali: 'Friends', Shen: 'Friends' }]
    },
    {
        name: 'Khazix',
        world: 'Void',
    ...
    },
    {
        ...
        type: ['Tank', 'Support'],
        release: '2011-07-13',
        linksWith: [{ Diana: 'Ennemy', Aphelios: 'Potential Ennemy' }]
    },
    {
        name: 'Lillia',
        world: 'Ionia',
    ...
    },
    {
        ...
        type: ['Mage'],
        release: '2013-04-30',
        linksWith: [{ Trundle: 'Friends\nAllie', Ashe: 'Ennemy', Anivia: 'Ennemy', Sejuani: 'Ennemy', Velkoz: 'Ennemy', Volibear: 'Ennemy' }]
    },
    {
        name: 'Lucian',
        world: 'Runeterra',
        ...
        type: ['Marksman'],
        release: '2013-08-22',
        linksWith: [{ Senna: 'Girlfriend', Thresh: 'Ennemy', Vex: '???' }]
    },
    {
        name: 'Lulu',
        world: 'Bandle City',
    ...
    },
    {
        ...
        type: ['Mage', 'Support'],
        release: '2010-10-19',
        linksWith: [{ Garen: 'Brother', Ezreal: 'Potential Boyfriend', Galio: 'Friends', Sylas: 'Friends', Zoe: 'Ennemy' }]
    },
    {
        name: 'Malphite',
        world: 'Ixtal',
    ...
    },
    {
        ...
        type: ['Marksman'],
        release: '2010-09-08',
        linksWith: [{ Illaoi: 'Friends', TwistedFate: 'Friends', Graves: 'Allie', Gangplank: 'Ennemy' }]
    },
    {
        name: 'Mordekaiser',
        world: 'Noxus',
    ...
    },
    {
        ...
        type: ['Fighter', 'Tank'],
        release: '2009-10-01',
        linksWith: [{ Sivir: 'Friends', Talliyah: 'Friends', Renekton: 'Ennemy', Xerath: 'Ennemy', Azir: 'Allie' }]
    },
    {
        name: 'Nautilus',
        world: 'Bilgewater',
    ...
    },
    {
        ...
        type: ['Fighter', 'Assassin'],
        release: '2010-02-02',
        linksWith: [{ Aatrox: 'Ennemy', AurelionSol: 'Ennemy', Zoe: 'Ennemy' }]
    },
    {
        name: 'Poppy',
        world: 'Demacia',
    ...
    },
    {
        ...
        type: ["Marksman", 'Assassin'],
        release: '2013-03-01',
        linksWith: [{ Garen: 'Allie', XinZhao: 'Allie' }]
    },
    {
        name: 'Rakan',
        world: 'Ionia',
    ...
    },
    {
        ...
        type: ["Support"],
        release: '2022-02-17',
        linksWith: [{ Camille: 'Ennemy', Ekko: '???', Viktor: '???' }]
    },
    {
        name: 'Renekton',
        world: 'Shurima',
    ...
    },
    {
        ...
        type: ["Fighter", 'Mage'],
        release: '2011-04-26',
        linksWith: [{ Tristanna: 'Potential girlfriend', Heimerdinger: 'Ennemy' }]
    },
    {
        name: 'Ryze',
        world: 'Runeterra',
    ...
    },
    {
        ...
        type: ['Tank'],
        release: '2012-01-17',
        linksWith: [{ Udyr: 'Potential Family', Olaf: 'Friends', Ashe: 'Friends\nEnnemy', Lissandra: 'Ennemy' }]
    },
    {
        name: 'Senna',
        world: 'Runeterra',
        ...
        type: ['Marksman', "Support"],
        release: '2019-11-10',
        linksWith: [{ Lucian: 'Boyfriend', Tresh: 'Ennemy', Vex: '???' }]
    },
    {
        name: 'Seraphine',
        world: 'Piltover',
    ...
    },
    {
        ...
        type: ["Tank"],
        release: '2010-03-24',
        linksWith: [{ Zed: 'Family\nEnnemy', Akali: 'Friends', Shen: 'Friends', Jhin: 'Ennemy' }]
    },
    {
        name: 'Shyvana',
        world: 'Demacia',
    ...
    },
    {
        ...
        type: ["Tank", 'Fighter'],
        release: '2009-04-18',
        linksWith: [{ Riven: 'Ennemy', Warwick: 'Ennemy' }]
    },
    {
        name: 'Sion',
        world: 'Noxus',
    ...
    },
    {
        ...
        type: ['Support', 'Fighter'],
        release: '2013-01-23',
        linksWith: [{ Lucian: 'Ennemy', Senna: 'Ennemy', Vex: '???' }]
    },
    {
        name: 'Tristana',
        world: 'Bandle City',
    ...
    },
    {
        ...
        type: ["Fighter"],
        release: '2012-12-19',
        linksWith: [{ Jinx: 'Sister\nEnnemy', Caitlyn: 'Potential Girlfriend\nFriends', Ekko: 'Potential Friends' }]
    },
    {
        name: 'Viego',
        world: 'Shadow Isles',
        ...
        type: ["Assassin"],
        release: '2021-01-21',
        linksWith: [{ Hecarim: 'Allie\nEnnemy', Kalista: 'Allie\nEnnemy', Gwen: 'Ebnnemy', Maokai: 'Ennemy', Yorick: 'Ennemy', Nilah: '???' }]
    },
    {
        name: 'Viktor',
        world: 'Zaun',
        ...
        type: ['Mage'],
        release: '2011-12-29',
        linksWith: [{ Blitzcrank: 'Son', Jayce: 'Ennemy', Renata: '???' }]
    },
    {
        name: 'Vladimir',
        world: 'Noxus',
    ...
    },
    {
        ...
        type: ["Mage"],
        release: '2011-10-05',
        linksWith: [{ Azir: 'Friends\nTeacher\nEnnemy', Nasus: 'Ennemy', Renekton: 'Ennemy' }]
    },
    {
        name: 'XinZhao',
        world: 'Demacia',
    ...
    },
    {
        ...
        type: ['Fighter', "Assassin"],
        release: '2013-12-13',
        linksWith: [{ Yone: 'Brother\nEnnemy', Talliyah: 'Mentor' }]
    },
    {
        name: 'Yone',
        world: 'Ionia',
    ...
    },
    {
        ...
        type: ["Assassin"],
        release: '2012-11-13',
        linksWith: [{ Shen: 'Family\nEnnemy', Velkoz: 'Ennemy', Xayah: 'Ennemy' }]
    },
    {
        name: 'Zeri',
        world: 'Zaun',
